/*
 * @Author: py.wang 
 * @Date: 2020-09-29 15:12:35 
 * @Last Modified by: py.wang
 * @Last Modified time: 2020-10-09 18:52:52
 */

// Endian-neutral encoding:
// Fixed--length numbers are encoded with least-significant byte first.
// In addition we support variable length "variant" encoding.
...
#endif  // STORAGE_LEVLEDB_UTIL_CODING_H